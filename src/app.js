...
export default () => {
  ...
  const addGroupItem = () =>
    setGroupsItems((oldGroupItems) => [...oldGroupItems, Math.random()]);
  const removeFirstGroupItem = () =>
    setGroupsItems(([, ...nextGroupItems]) => nextGroupItems);
      ...
      <div className="root">
        <div className="container">
          ...
          <CSSTransition
            ...
            classNames="fade"
          >
            <div className="fade">Visible</div>
          </CSSTransition>
        </div>
          ...
          <TransitionGroup duration={duration} exit={false}>
            <CSSTransition key={colorItem} classNames="fade">
              <div
                className="fade"
                style={{
                  background: colorItems[colorItem],
